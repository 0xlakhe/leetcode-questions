...
Given an array arr[] of distinct integers of size n and a value sum, the task is to find the count of triplets (i, j, k), with the sum of (arr[i] + arr[j] + arr[k]) smaller than the given value sum.
